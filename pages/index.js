      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          ...
          <div className="text-5xl flex justify-center gap-16 py-3 text-grey-300">
            <ExternalLink href="mailto:blackkiverson@gmail.com">
              <AiFillMail />
            </ExternalLink>
            <ExternalLink href="https://linkedin.com/in/samuel-onyebuchi-igbokwe-650413169">
              <AiFillLinkedin />
            </ExternalLink>
            <ExternalLink href="https://github.com/blackkiverson">
              <AiFillGithub />
            </ExternalLink>
          </div>
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            ...
            <div className="text-center mx-auto shadow-lg p-5 rounded-xl my-10 dark:bg-gray-100">
              ...
              <p className="py-2">
                Advising you on the best tech practice out there, and on various
                issues.
              </p>
